    ...
    <form method="POST" action="conexion.php">
      ...
      <table class="egt" id="maintable">
        ...
        <tr>
          ...
          <td colspan="2">
         <select name="id_inst" >
          <?php foreach ($registro4 as $int):?>
            
        <?php endforeach; ?>
        </select>
          </td>
          <td colspan="2" width="20%">Código</td>
          <td colspan="2"><input type="text" name="codigo" value="POO<?php  echo $id_proy+1; ?>"></td>
        ...
        <tr>
          ...
          <select name="tipo_proy">
            ...
            <option value="Proyecto en Conjunto">Proyecto en Conjunto</option>
            <option value="Proyecto de Concurso">Proyecto de Concurso</option>
          </select>
          </td>
          <td colspan="2">Tipo de Documento</td>
          <td colspan="2"><input type="text" name="tipo_doc" value="Formulacion de Proyecto"></td>
        </tr>
      </table>
      ...
      <table id="table_co">
        ...
        <tr>
          ...
          <td colspan="4"><input type="text" name="res_proy" value="<?php echo $_SESSION[nombre] ?>"></td>
        </tr>
